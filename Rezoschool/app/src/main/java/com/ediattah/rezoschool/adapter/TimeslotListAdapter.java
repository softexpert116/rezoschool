...
//    public CourseTime sel_courseTime;
    ...
    public TimeslotListAdapter(Context _context, ArrayList<Course> _arrayList, int _dayOfWeek) {
        context = _context;
