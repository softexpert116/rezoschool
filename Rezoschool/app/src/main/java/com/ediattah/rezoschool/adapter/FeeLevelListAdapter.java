...
public class FeeLevelListAdapter extends BaseAdapter {
    ArrayList<FeeModel> arrayList;

    FinanceSettingActivity activity;

    public FeeLevelListAdapter(FinanceSettingActivity _activity, ArrayList<FeeModel> _arrayList) {
        activity = _activity;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.cell_fee_level, null);
        }
        TextView txt_level = view.findViewById(R.id.txt_level);
        txt_level.setText(model.level);
        ...
        ibtn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                activity.openAddDialog(false, true);
            }
        });
